# Machine learning fundamentals guide installation
...
activate machine_learning_fundamentals
```
...
To move beyond notebook prototyping, all reusable code should go into the `machine_learning_fundamentals/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `machine_learning_fundamentals` folder and use the modules inside your notebooks :
...
```python
from machine_learning_fundamentals.utils.paths import data_dir
data_dir()
```
